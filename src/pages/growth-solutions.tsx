...
const GrowthSolutions: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Growth Solutions - Perssonify</title>
        <meta name="description" content="High-performance marketing solutions to grow your business. Performance marketing, social media, email automation, and more." />
      </Head>
      <Layout>
