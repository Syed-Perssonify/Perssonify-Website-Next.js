...
const About: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>About Us - Perssonify</title>
        <meta name="description" content="Learn about Perssonify's mission to bring growth and scale to life through innovative solutions and strategic partnerships." />
      </Head>
      <Layout>
        <div className="min-h-screen bg-background">
          ...
          {/* CTA Section */}
          <section className="pt-24 pb-4 bg-gradient-to-br from-primary/10 to-accent/10">
