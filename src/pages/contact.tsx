...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - Perssonify</title>
        <meta name="description" content="Get in touch with Perssonify to start your growth journey. We're here to help you scale your business." />
      </Head>
      <Layout>
